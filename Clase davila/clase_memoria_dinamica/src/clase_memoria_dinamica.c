...
////	if(pEntero !=NULL)
////	{
////		OK, CONSIGUIO EL LUGAR NECESARIO.
////	}
...
//	if(pBuffer !=NULL)
//	{
//		pArrayEntero =pBuffer; // si no hay mas espacio para agrandar el array, realloc devuelve null.
//	}
//
//	//un realoc a cero solo deja la nota. un free elimina la nota
//	free(pArrayEntero);
